...
function ManageTasks() {
    ...
    const { data: jobs, PageTag } = usePagination1<Job>({ url: "/api/job/all" })
...
export function AdminDashboard() {
    ...
    return (
        <div className="flex flex-col lg:flex-row w-full gap-4" >
            ...
            <div className="flex flex-row lg:flex-col gap-4 w-full lg:w-60 lg:sticky lg:top-0 self-start overflow-auto" >
